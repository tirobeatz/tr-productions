    ...
    <main className="min-h-screen bg-[#050505] text-white relative">
      ...
      <div className="fixed inset-0 pointer-events-none">
        ...
        <svg className="absolute inset-0 w-full h-full opacity-[0.03]" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <pattern id="soundWavesContact" x="0" y="0" width="100%" height="200" patternUnits="userSpaceOnUse">
          ...
          <rect width="100%" height="100%" fill="url(#soundWavesContact)" />
        </svg>
      </div>
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        <svg className="absolute bottom-0 left-0 w-full h-[60%] opacity-[0.04]" viewBox="0 0 1440 600" preserveAspectRatio="none">
          <path d="M0 300 Q 360 150, 720 300 T 1440 300 L 1440 600 L 0 600 Z" fill="url(#waveGradientContact)"/>
          <defs>
            <linearGradient id="waveGradientContact" x1="0%" y1="0%" x2="0%" y2="100%">
