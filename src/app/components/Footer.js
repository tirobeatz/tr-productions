...
export default function Footer() {
  ...
  return (
    <motion.footer
      className="border-t border-white/5 py-12 md:py-16 px-4 md:px-6 bg-[#050505] relative z-10"
      initial={{ opacity: 0 }}
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="border-t border-white/5 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex gap-6">
            <a
              href="https://www.instagram.com/tr.productionz/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-600 hover:text-[#8B5CF6] transition text-sm flex items-center gap-2"
            >
            ...
            <a
              href="https://www.youtube.com/@trproductionz"
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-600 hover:text-[#8B5CF6] transition text-sm flex items-center gap-2"
            >
            ...
            <a
              href="https://www.tiktok.com/@trproductions"
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-600 hover:text-[#8B5CF6] transition text-sm flex items-center gap-2"
            >
